...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/rawg_search_games \
  -H 'Content-Type: application/json' \
  -d '{"query":"zelda"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/rawg_search_games`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
